                ...
                <div class="bee-block">
                    ...
                    <div class="bee-content">
                        ...
                        <div class="bee-buttons">
                            ...
                            <a :href="$td('https://medium.com/@honeeapp/bee-staking-at-up-to-24-apr-2c4d4712896', 'index.bee-stake-url')" class="btn btn-4" target="_blank"><img src="/img/honee.svg" alt="Stake BEE and earn"> {{ $td('Stake BEE', 'index.bee-stake')}}</a>
