export default {
	...
	index: {
		...
		'bee-title': 'Токен BEE',
		'bee-p1': 'Токен кошелька Honee, BEE, представляет собой простой служебный токен стандарта BEP-20 ({0}). Он предоставляет широкий спектр преимуществ и стимулов для пользователей кошелька Honee.',
		'bee-p1-href': 'контракт',
