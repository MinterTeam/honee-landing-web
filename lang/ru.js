export default {
	...
	index: {
		...
		'bee-title': 'Токен BEE',
		'bee-p1': 'Токен кошелька Honee (BEE) – это простой утилити-токен BEP-20 {0}, который предоставляет широкий спектр преимуществ и стимулов для пользователей кошелька Honee.',
		'bee-p1-href': 'контракт',
		'bee-p2': 'Владельцы токенов BEE открывают множество преимуществ при использовании кошелька Honee, включая вознаграждения за действия, повышенную доходность для программ заработка в приложении и скидки на использование услуг DeFi.',
