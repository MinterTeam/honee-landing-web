export default {
	...
	copytrading: {
		...
		'description': 'Пользователи кошелька Honee зарабатывают до 10% в неделю, копируя портфели экспертов.',
		'hello-title': 'Зарабатывайте, копируя сделки экспертов',
		'hello-description': 'Пользователи кошелька Honee зарабатывают до 10% в неделю, копируя портфели экспертов.',
