export default {
	...
	index: {
		...
		'bee-p2': 'Владельцы токенов BEE открывают множество преимуществ при использовании кошелька Honee, включая вознаграждения за действия, повышенную доходность для разных вариантов заработка внутри приложения и скидки на использование DeFi-сервисов.',
	...
	battle: {
		...
		'description': 'Раскрути свой виртуальный крипто-портфель и преврати его в реальные деньги! Участие бесплатное, аирдроп каждую неделю. Призовой фонд более $7000!',
		'hello-title': 'Битва портфелей',
		'hello-subtitle': '24 октября – 5 декабря',
		'hello-description': 'Раскрути свой виртуальный крипто-портфель и преврати его в реальные деньги! Участие бесплатное, аирдроп каждую неделю. Призовой фонд более $8500!',
		'join': 'Вступить в битву',
		'join-url': '#',
		...
		'all-participants-button': 'Посмотреть все портфели',
		'all-participants-url': '#',
	},
};
