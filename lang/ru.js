export default {
	...
	'metagarden-token': {
		'title': 'Токен METAGARDEN',
		'description': 'Это служебный токен play-to-earn платформы мини-игр Metagarden, выполняющий ключевую роль в функционировании платформы.',
		'hello-title': 'METAGARDEN',
		'hello-description': 'Это служебный токен play-to-earn платформы мини-игр Metagarden, выполняющий ключевую роль в функционировании платформы.',
		'start-button': 'Майнить METAGARDEN',
		'buy-spot-url': 'https://my.honee.app/ru/metagarden/buy-spot',
