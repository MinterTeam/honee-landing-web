export default {
	...
	battle: {
		...
		'description': 'Преврати свой виртуальный крипто-портфель в реальные деньги! $8500 - призовой фонд!',
		'hello-title': 'Битва портфелей',
		'hello-subtitle': '24 октября – 5 декабря',
		'hello-description': 'Преврати свой виртуальный крипто-портфель в реальные деньги! Участие бесплатное, аирдроп каждую неделю. Призовой фонд более $8500!',
