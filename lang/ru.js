export default {
	...
	'metagarden-token': {
		...
		'mining-privilege-button': 'Купить майнинг-спот',
	...
	'metagarden-influencer': {
		...
		'description': 'Станьте партнером платформы Metagarden на ранней стадии! Создавайте контент про нас. Если вам интересно, напишите.',
